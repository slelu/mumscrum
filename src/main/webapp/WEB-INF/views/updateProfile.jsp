...
<a href="#" class="close" data-dismiss="alert">&times;</a>${message}<br />
					...
					<form:form method="post" action="${pageContext.request.contextPath}/updateProfile" enctype="multipart/form-data"
					 commandName="employee" class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<form:input path="username" cssClass="form-control input-sm" value="${employee.username}" readonly="true" />
