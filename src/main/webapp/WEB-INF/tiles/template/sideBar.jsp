		...
		<ul class="nav" id="side-menu">
			...
			<li><a href="#"><i class="fa fa-user fa-fw"></i> Human
				...
				<ul class="nav nav-second-level">
					<li><a href="flot.html"><i class="fa fa-plus fa-fw"></i>
							New Employee</a></li>
					<li><a href="morris.html"><i class="fa fa-list-alt fa-fw"></i>
							Employees List</a></li>
			...
			<security:authorize access="hasRole('DEVELOPER')">
				<li><a href="#"><i class="fa fa-square fa-fw"></i>
					...
					<ul class="nav nav-second-level">
						<li><a href="developerUserStoryList"><i class="fa fa-edit fa-fw"></i>
								Estimate User Story</a></li>
						<li><a href="developerNewWorklog"><i class="fa fa-list-alt fa-fw"></i>
								Add Work Log</a></li>
					</ul> <!-- /.nav-second-level --></li>
			</security:authorize>
			<security:authorize access="hasRole('TESTER')">
				<li><a href="#"><i class="fa fa-check-square fa-fw"></i>
					...
					<ul class="nav nav-second-level">
						<li><a href="testerUserStoryList"><i class="fa fa-edit fa-fw"></i>
								Estimate User Story</a></li>
						<li><a href="testerNewWorkLog"><i class="fa fa-list-alt fa-fw"></i>
								Add Work Log</a></li>
					</ul> <!-- /.nav-second-level --></li>
			</security:authorize>
